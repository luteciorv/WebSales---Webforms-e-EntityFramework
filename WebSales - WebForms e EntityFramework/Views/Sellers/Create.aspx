<%@ Page Title="Adicionar Novo Vendedor" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="WebSales___WebForms_e_EntityFramework.Views.Sellers.Create" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
        ...
        <div>
            ...
            <br />
            <asp:TextBox runat="server" ID="tbEmail" class="" placeholder="Digite o email" Height="25px" Width="150px" />
        ...
        <div>
            <asp:Table ID="Table1" runat="server" CellSpacing="2">
                ...
                <asp:TableRow HorizontalAlign="Center">
                    <asp:TableCell>
                        <asp:TextBox runat="server" ID="tbDataDay" MaxLength="2" placeholder="1" Height="25px" Width="50px" />
                    </asp:TableCell><asp:TableCell>
                        <asp:TextBox runat="server" ID="tbDataMonth" MaxLength="2" placeholder="1" Height="25px" Width="50px" />
                    </asp:TableCell><asp:TableCell>
                        <asp:TextBox runat="server" ID="tbDataYear" MaxLength="4" placeholder="2000" Height="25px" Width="100px" />
        ...
        <div>
            ...
            <br />
            <asp:TextBox runat="server" ID="tbSalary" class="" placeholder="Digite o nome" Height="25px" Width="150px" />
